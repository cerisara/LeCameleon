%************************************************
\chapter{Introduction: Modeling the Language}\label{ch:introduction}
%************************************************
...
work on information theory~\citet{shannon1948mathematical}\footnote{
...
In \textit{Three Models for the Description of Language}, Chomsky states~\citet[p.~113]{chomsky1956three}:
...
While \citet{bahdanau2015neural} improved neural machine translation by adding attention
to an RNN-based encoder--decoder, \citet{vaswani2017attention} proposed replacing recurrence
...
such as DeepSeek Sparse Attention~\cite{deepseekai2025deepseekv32pushingfrontieropen}, to reduce this compute 
