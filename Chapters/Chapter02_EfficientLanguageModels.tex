...
The concept was introduced by \citep{kim2016sequence} for machine translation, 
...
can outperform its teacher. This appears possible on specific tasks: \citep{hsieh2023distilling}, 
...
visited by the student. \citep{agarwal2024onpolicy} show that knowledge distillation 
...
}. \citep{huang2024hardertasksneedexperts} propose a routing strategy inspired by
...
\citep{lample2019largememorylayersproduct}, where the approach is made
...
Using the notation of \citep{lample2019largememorylayersproduct},
...
Expert Retrieval), proposed by \citep{he2024mixturemillionexperts}. Conceptually,
...
following the pseudo-code of \citep{he2024mixturemillionexperts}.
