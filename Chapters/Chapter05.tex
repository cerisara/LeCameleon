...
TopK-based sparsity require all-to-all communication and these data transfers make sparse
...
during the MLP forward and backward. There are many sparse GPU kernels in the literature
